                ...
                <form className="signup-form p-4" style={{ boxShadow: "1px 1px 10px green" }}>
                    ...
                    <div className="input-field-box mb-5">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-10">
                                <input type="text" placeholder="Please Enter Your Name Here ." className="form-control border-success border-2" />
                            </div>
                            {/* End Column */}
                        </div>
                        {/* End Grid System */}
                    ...
                    <div className="input-field-box mb-5">
                        ...
                        <div className="row align-items-center">
                            ...
                            {/* Start Column */}
                            <div className="col-md-10">
                                <input type="password" placeholder="Please Enter Your Password Here ." className="form-control border-success border-2" />
                            </div>
                            {/* End Column */}
                        </div>
                        {/* End Grid System */}
