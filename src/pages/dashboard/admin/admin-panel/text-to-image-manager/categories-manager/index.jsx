...
const TextToImageCategoriesManager = () => {
    return (
        <div className="text-to-image-categories-manager">
            ...
            <Link href="/dashboard/admin/admin-panel/text-to-image-manager/categories-manager/update-category-info" className="btn btn-danger mb-3 d-block mx-auto w-25">Update Category Info</Link>
        </div>
    );
}
