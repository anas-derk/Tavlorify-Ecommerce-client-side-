...
export default function ImageToImage({
    ...
    const imageToImageGenerateByAI = async () => {
        try {
            ...
            const result = (await axios.get(`${process.env.BASE_API_URL}/generated-images/generate-image-using-image-to-image-service?imageLink=${imageLink}&categoryName=${categoriesData[categorySelectedIndex].name}&styleName=${categoryStyles[selectedStyleIndex].name}&paintingType=${paintingType}&isExistWhiteBorder=${isExistWhiteBorderWithPoster}&frameColor=${frameColor}`)).data;
