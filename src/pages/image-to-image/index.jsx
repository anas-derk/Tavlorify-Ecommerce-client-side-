                        ...
                        <section className="painting-details">
                            {windowInnerWidth >= 767 && <>
                                ...
                                {appearedPaintingDetailsList.includes("product-information") && <div className="product-information-box p-3 pb-4 pt-4">
                                    <p className="mb-0 content fw-bold">Premium matt papper / Affisch</p>
                                    ...
                                    <ol>
                                        <li>Utmärkt Kvalitet: Vår 200 g/m² papperstjocklek gör det inte bara robust och långlivat, utan ger också en förstklassig kvalitetskänsla till dina tryck.</li>
                                        <li>Miljövänligt Val: Vi använder FSC-certifierat papper eller likvärdiga certifieringar. Detta innebär att du inte bara investerar i ditt projekt, utan också i en hållbar framtid för människor och planeten.</li>
                                        <li>Skräddarsydd Produktion: Våra affischer och tryck tillverkas och levereras på begäran. Detta säkerställer att varje produkt är färsk och anpassad efter dina specifika behov.</li>
                                    </ol>
                                    ...
                                    <p className="mb-0 content fw-bold">Hängare</p>
                                    ...
                                    <ol>
                                        <li>Hängarna är tillverkade av furuträ och finns i fyra färgvarianter: svart, vit, naturlig träfärg och mörkbrunt trä.</li>
                                        <li>Den bomullsrep som är fäst längst upp matchar hängarens färg.</li>
                                        <li>Designade magnetiskt, skadar inte hängarna affischen och gör det också enkelt att byta utskrifter, vilket gör dem till ett mångsidigt och hållbart alternativ.</li>
                                    </ol>
                                    ...
                                    <p className="mb-2 content fw-bold">Träinramad Affisch.</p>
                                    <p className="mb-2 content">Våra färdiga träinramade affischer är stabila, hållbara och redo att hängas upp direkt!</p>
                                    <p className="mb-2 content fw-bold">Funktioner:</p>
                                    <ol>
                                        <li>Ramarna är tillverkade av furuträ och finns i 4 färger: svart, vit, naturlig träfärg och mörkbrunt trä.</li>
                                        <li>De är 20-25 mm tjocka och 10-14 mm breda, vilket ger den perfekta balansen mellan hållbarhet och stil.</li>
                                        <li>För att hålla din affisch i bästa skick använder vi splitterfri, transparent plexiglas för att skydda den från skador.</li>
                                        <li>Vi inkluderar upphängningsbeslag med varje beställning, vilket gör det enkelt att hänga upp ramen både horisontellt och vertikalt.</li>
                                        <li>Affischen är klar att hänga eftersom den levereras inramad. Den är redo att hängas direkt på väggen.</li>
                                    </ol>
                                    ...
                                    <p className="mb-2 content fw-bold">Canvas</p>
                                    ...
                                    <p className="mb-2 content fw-bold">Funktioner:</p>
                                    <p className="mb-2 content">Vi använder trä till sträckramarna som är ansvarsfullt källat, främst trä med FSC-certifiering, för att skapa våra canvas-tryck och säkerställa en långvarig och högkvalitativ produkt.</p>
                                    <p className="mb-2 content">Vårt canvas-tryck finns i 2 cm tjocklek.</p>
                                    <p className="mb-2 content">Vårt canvas-tryck levereras med upphängningsbeslag för enkel installation.</p>
                                    <p className="mb-2 content">Vi använder belagt tyg, en blandning av bomull och polyester, för vårt canvas-material. Det ger en vikt på ungefär 300-350 gsm och en tjocklek på 350-400 mikron, vilket ger dig en robust och hållbar produkt.</p>
                                    <p className="mb-2 content">Observera att färgade kanter inte stöds. Vi försäkrar dock att vårt canvas-tryck är en vacker och högkvalitativ produkt som kommer att ge liv åt vilket rum som helst.</p>
